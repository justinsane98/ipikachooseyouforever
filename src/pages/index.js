      ...
      <div className="h-screen relative overflow-hidden">
        ...
        <div className={`transition-opacity duration-250 ${this.state.loading ? "opacity-0" : "opacity-100"}`}>
          ...
          {this.state.showResults &&
            <div className={`relative grid h-screen place-content-center w-full flex justify-center text-center transition-opacity duration-250 ${this.state.showResults ? "opacity-100" : "opacity-0"}`}>
              <div className="rounded-xl bg-black-75 p-4">
                <div className="rounded-xl bg-black py-8 px-16 text-white">
                {this.state.success &&
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-32 fill-green inline-block">
                ...
                {this.state.fail &&
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-32 fill-red inline-block">
                ...
                <div className="my-4 text-xl font-bold">
                  <div className={`text-3xl mb-2 ${this.state.success ? "text-green" : "text-red"}`}>{this.state.success ? "+" : "-"}{this.formatPrice(this.state.difference)}</div>
                  {/* TODO format negative subtotal better */}
                  <div className="text-5xl mb-4">{this.formatPrice(this.state.subTotal)}</div>
                  ...
                  <div className="flex justify-center w-full my-4 text-black">
                    <div className={`w-16 h-16 rounded-full mx-2 shadow-inner flex content-center justify-center items-center overflow-hidden ${this.state.fails > 0 ? "bg-red" : "bg-white-25"}`}>
                      {this.state.fails > 0 &&
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-12 fill-black-25 inline-block">
                    ...
                    <div className={`w-16 h-16 rounded-full mx-2 shadow-inner flex content-center justify-center items-center overflow-hidden ${this.state.fails > 1 ? "bg-red" : "bg-white-25"}`}>
                      {this.state.fails > 1 &&
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-12 fill-black-25 inline-block">
                        <path d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zm97.9-320l-17 17-47 47 47 47 17 17L320 353.9l-17-17-47-47-47 47-17 17L158.1 320l17-17 47-47-47-47-17-17L192 158.1l17 17 47 47 47-47 17-17L353.9 192z"/>
                      </svg>
                    ...
                    <div className={`w-16 h-16 rounded-full mx-2 shadow-inner flex content-center justify-center items-center overflow-hidden ${this.state.fails > 2 ? "bg-red" : "bg-white-25"}`}>
                      {this.state.fails > 2 &&
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-12 fill-black-25 inline-block">
                        <path d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zm97.9-320l-17 17-47 47 47 47 17 17L320 353.9l-17-17-47-47-47 47-17 17L158.1 320l17-17 47-47-47-47-17-17L192 158.1l17 17 47 47 47-47 17-17L353.9 192z"/>
                      </svg>
                ...
                <div>
                  {this.state.showNextButton &&
                    <button onClick={(e)=> {e.preventDefault();this.showNext()}} className="mt-4 rounded bg-green text-3xl text-white font-bold px-4 py-2 w-full transition-all hover:scale-110">Next</button>
                  }
                  {this.state.showRetryButton &&
                    <button onClick={(e)=> {e.preventDefault();this.retry()}} className="mt-4 rounded bg-red text-3xl text-white font-bold px-4 py-2 w-full transition-all hover:scale-110">Try Again</button>
                  }
                  </div>
                </div>
              </div>
