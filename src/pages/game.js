      ...
      <div className="h-screen relative overflow-hidden bg-black">
        ...
        <div className={`transition-opacity duration-250 ${this.state.loading ? "opacity-0" : "opacity-100"}`}>
          ...
          {this.state.showResults &&
            <div className={`relative grid h-screen mt-4 1024px:mt-0 place-content-center w-full flex justify-center text-center transition-opacity duration-250 ${this.state.showResults ? "opacity-100" : "opacity-0"}`}>
              <div className="rounded-xl bg-black-75 p-2 1024px:p-4">
                <div className="rounded-xl bg-black py-4 px-4 1024px:px-8 text-white text-left w-[50vw] 768px:w-[25vw]">
                {this.state.success &&
          ...
          <div className={`relative z-10 grid h-screen mt-4 1024px:mt-0 place-content-center w-full flex justify-center text-center transition-opacity duration-250 ${this.state.showEndGame ? "opacity-100" : "opacity-0"}`}>
            <div className="rounded-xl bg-black-75 p-2 1024px:p-4">
              <div className="rounded-xl bg-black py-4 px-8 text-white text-left w-[75vw] 768px:w-[50vw] text-center">
          ...
          {this.state.card1 &&
            <div onClick={(e) => {e.preventDefault();this.chooseCard(1)}} className="h-auto max-w-[50vw] 475px:max-w-[33vw] -rotate-[5deg] ml-36 1024px:ml-6 transition duration-100 hover:cursor-pointer hover:scale-110 hover:-rotate-[3deg] pointer-events-auto">
              ...
              <img className="max-h-[75vh]" src={this.state.card1.image} alt={this.state.card1.name}/>
              </div>
          ...
          {this.state.card2 &&
            <div onClick={(e) => {e.preventDefault();this.chooseCard(2)}} className="h-auto max-w-[50vw] 475px:max-w-[33vw] -rotate-[5deg] 768px:rotate-[5deg] mr-36 1024px:mr-6 transition duration-100 hover:cursor-pointer hover:scale-110 hover:-rotate-[3deg] 768px:hover:rotate-[3deg] pointer-events-auto">
              <div className="rounded-xl overflow-hidden">
                <img className="max-h-[75vh]" src={this.state.card2.image} alt={this.state.card2.name}/>
              </div>
              {this.state.showPrices &&
